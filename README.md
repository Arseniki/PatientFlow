...
Un outil professionnel de Simulation à Evènement Discret (DES) pour l'analyse de M/M/c/k₀ des systèmes de file d'attente avec une interface graphique. Parfait pour la planinfication de la capacité et l'optimisation des centres de santé. 
